        ...
        <form action='../../actions/produto.php' method='post'>
            ...
            <div class='form-group'>
                ...
                <input type='text' class='form-control' name='descricao' id='descricao'
                    placeholder='Informe a descrição do produto' value=<?php echo $produto[ 'descricao' ] ?>>
            </div>

            <div class='form-group'>
                <label for='quantidade'>Quantidade Produto:</label>
                <input type='number' class='form-control' name='quantidade' id='quantidade'
                    placeholder='Informe a quantidade do produto' value=<?php echo $produto[ 'qtde_estoque' ]?>>
            </div>
